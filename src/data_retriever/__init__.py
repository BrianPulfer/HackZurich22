from data_retriever.data_loader import donwload_html, donwload_xml
from data_retriever.text_processing import split_string_chunks, join_chunks_in_strings
